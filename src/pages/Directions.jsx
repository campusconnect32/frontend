...
const Directions = () => {
  ...
  const [routes, setRoutes] = useState([
    {
      id: 1,
      from: "Parktown Campus",
      to: "Wits Main Campus",
      duration: "15-20 minutes",
      mode: "bus",
      description: "~15-20 minutes by bus walk",
      videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ"
    },
    {
      id: 2,
      from: "Solomon Mahlangu House",
      to: "Origins Centre",
      duration: "2-3 minutes",
      mode: "walk",
      description: "~2-3 minutes walk",
      videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ"
    },
    {
      id: 3,
            ...
            {filteredRoutes.map((route) => (
              <div key={route.id} className="bg-white rounded-xl p-5 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <div className="flex items-center gap-3 mt-1">
                      ...
                      <span className={`px-2 py-0.5 rounded-full text-xs font-medium ${
                        route.mode === 'bus' ? 'bg-blue-100 text-blue-700' : 'bg-green-100 text-green-700'
                      }`}>
                  ...
                  <button
                    onClick={() => setSelectedVideo(selectedVideo === route.id ? null : route.id)}
                ...
                {selectedVideo === route.id && (
                  <div className="mt-4">
                    <div className="relative pb-[56.25%] h-0">
                      <iframe
                        src={route.videoUrl}
                        title={`Directions from ${route.from} to ${route.to}`}
